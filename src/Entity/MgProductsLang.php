...
/**
 * @ORM\Entity(repositoryClass="App\Repository\MgProductsLangRepository")
 * @ORM\HasLifecycleCallbacks
 */
class MgProductsLang
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\MgProducts", inversedBy="contents")
    ...
    public function initializeSlug()
    {
        if(empty($this->slug)) {
            $slugify = new Slugify();
            //$this->slug = $slugify->slugify($this->id . '-' . $this->name);
